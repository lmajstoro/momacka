...
export default function Majica({ items }: MajicaProps) {
  ...
  return (
    <section id="majica" className="px-2 py-16 sm:px-4 sm:py-20">
      ...
      <div className="mx-auto max-w-7xl">
            ...
            {photos.map((item) => {
              ...
              return (
                <button
                  ...
                  className="group relative aspect-[9/16] overflow-hidden bg-black focus:outline-none focus-visible:ring-2 focus-visible:ring-gold"
                  aria-label={item.alt}
                >
                  <Image
                    src={item.src}
        ...
        {video ? (
          <div className="mx-auto mt-1.5 w-[80%] sm:mt-2 md:w-[37%]">
